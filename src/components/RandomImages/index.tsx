    ...
    <div className="sc-randomimages" onClick={changeImgAuto}>
      <Row>
        <RandomImagesContainer
          imageToShow={0} //{imagesToShow[0]}
          img1={listImages[0]} //{listImages[images[0][0]]}
          img2={listImages[0]} //{listImages[images[0][1]]}
        />
        <RandomImagesContainer
          imageToShow={0} //{imagesToShow[1]}
          img1={listImages[1]} //{listImages[images[1][0]]}
          img2={listImages[1]} //{listImages[images[1][1]]}
        />
      </Row>
    </div>
  )
