...
export const contentsLuxeRoom: Record<string, IContentByLang> = {
  ...
  item0: {
    fr: 'Chambre Deluxe environ 30m² pour 2 personnes maximum',
    en: 'en-VUE MER DE 27M² À 29M² - 2 PERS',
    ru: 'ru-VUE MER DE 27M² À 29M² - 2 PERS'
  },
  item1: {
    fr: 'Lit Double King size 180*200 ou 2 lits jumeaux 2x90*200',
  ...
  item4: {
    fr: ' Soit côté parking avec terrasse privée avec vue sur le Port du Croûton',
  ...
  item9: {
    fr: ' Baignoire ou Douche avec Ciel de pluie',
...
export const contentsLuxeRoomItems: IContentByLang[] = [
  {
    fr: 'Chambre Deluxe environ 30m² pour 2 clients max',
    en: 'Deluxe room about 30m² for 2 persons maximum',
    ru: 'ru-VUE MER DE 27M² À 29M² - 2 PERS'
  },
  {
  ...
  {
    fr: 'Baignoire ou Douche avec Ciel de pluie',
    en: 'Bath or shower with rain effect',
    ru: 'ru-PRODUITS D’ACCUEIL HERMÈS'
  },
  {
    fr: 'Produits d’accueil Acqua Di Parma',
