...
export const contentsHome: Record<string, IContentByLang> = {
  ...
  text1_2: {
    fr: `Le Beach Hôtel, 35 chambres et 5 étoiles. Les pieds dans l’eau entre Cannes et Nice. Avec sa plage privée, c’est une adresse dédiée à la joie de vivre. Le matin, seul au monde, vous prenez votre premier bain de mer. Au fil des vagues, la musique monte avec le soleil. La fête embrase Baba, le restau-rant de plage. Le bar en rotonde est un balcon sur la Méditerranée. Au calme, à l’ombre dans le jardin exotique ou sur la pergola du bassin à dé-bordement, rejoignez l’espace bien-être. Vous laissez filer vos pensées avec le vent. Le restaurant gastronomique Les Pêcheurs dresse ses nappes blanches pour le dîner. Vous vous endormez avec le bruit des vagues et une certitude. Demain il fera beau.`,
    en: `The Beach Hotel, with 35 rooms and 5 stars, is located right on the water between Cannes and Nice. With its private beach, it is an address dedicated to the joy of living. In the morning, you can take your first swim in the sea all by yourself. As the waves roll in, the music rises with the sun. The party ignites at Baba, the beach restaurant. The circular bar is a balcony overlooking the Mediterranean. In peace and quiet, in the shade of the exotic garden or on the pergola of the infinity pool, you can join the wellness area. You let your thoughts drift away with the wind. The gastronomic restaurant Les Pêcheurs sets its white tablecloths for dinner. You fall asleep to the sound of the waves with the certainty that tomorrow will be a beautiful day.`,
  ...
  text2: {
    fr: `Avec 35 chambres et suites de minimum 36 m2, vous êtes au Beach Hôtel comme dans votre maison. Epurées, elles invitent à la sérénité. Vous accé-dez aux chambres les coursives en lames de bois laquées blanches. Le sol en pierre se poursuit des espaces extérieures à l’intérieur des chambres. Cer-taines disposent d’un jardin privé et d’autres, à l’étage, ont des vues imprenables depuis leur terrasse. Des banquettes forment un salon intérieur, on peut lire un livre, rêver devant la vue ou dîner dans votre chambre sur la table basse en bois. Vous posez vos valises dans un grand dressing en acajou. Dans les vastes salles de bains, la lumière naturelle se mêle aux marbres roses.`,
    en: `With 35 rooms and suites, each measuring at least 36m², you will feel at home at the Beach Hotel. The rooms are minimalist and invite you to relax. You enter the rooms through white lacquered wooden walkways. The stone flooring extends from the outdoor spaces to the inside of the rooms. Some rooms have a private garden, while others on the upper floors have breathtaking views from their terrace. Sofas form an indoor lounge where you can read a book, daydream while taking in the view, or even dine in your room on the wooden coffee table. You can unpack your luggage in the spacious mahogany wardrobe. In the large bathrooms, natural light mixes with pink marble.`,
  ...
  text3: {
    fr: `Le restaurant Les Pêcheurs est une institution depuis les années 1940. Chaque matin, au retour du bateau de pêche, Le chef Nicolas Rondelli pro-pose une carte renouvelée selon la générosité de la mer. Tous les soirs, vous embarquez aux Pêcheurs comme à bord d’un yacht début de siècle. Le sol en marbre rouille s’avance au-dessus de la Méditerranée. Les murs en acajou vernis se jouent des reflets de l’eau. Les grandes baies vitrées s’effacent comme à l’arrière d’un bateau dominant la mer.`,
    en: `Le restaurant gastronomique Les Pêcheurs est une institution depuis les années 1940. Fidèle à la tradition, le chef Nicolas Rondelli travaille une carte mettant à l’honneur les produits de la Méditerranée. Dominant la mer, vous voilà comme sur le pont arrière d’un yacht du début du siècle.`,
  ...
  text4_1: {
    fr: `Baba, le restaurant de l’hôtel à ciel ouvert, est orchestré en partenariat avec le chef Assaf Granit et ses équipes. Toute la journée, sa cuisine médi-terranéenne voyage depuis Jérusalem. Les magnifiques parfums d’épices s’échappent de la cuisine en plein air. Autour du bar en rotonde, l’ambiance est à l’insouciance. La musique et l’énergie du Cap Jaffa mon-tent dans le ciel.`,
  ...
  text5: {
    fr: `Rareté absolue sur la Côte d’Azur, le Beach Hôtel dispose de sa propre plage. On profite d’une douce oisiveté sur un bain de soleil. On boit des cocktails entre amis. Autour du bar, on partage une partie backgammon en famille. Vous partez en promenade en pédalo, à vélo ou en bateau. Vous pouvez vous détendre à l’abri dans le jardin exotique, à l’ombre d’un pal-mier ou autour de la piscine.`,
