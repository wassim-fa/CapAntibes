...
export const contentsPrivilegeRoom: Record<string, IContentByLang> = {
  title: {
    fr: 'Chambre privilège',
    en: 'Privilege Room',
    ru: 'ru-la chambre de privilege'
  },
  description: {
    fr: 'Chambre privilège',
    en: 'Privilege Room',
...
export const contentsPrivilegeRoomItems: IContentByLang[] = [
  {
    fr: 'Chambre Privilege environ 38m² pour 3 clients max',
    en: 'Privilege room about 38m² for 3 persons maximum',
    ru: 'ru-VUE MER DE 27M² À 29M² - 2 PERS'
  },
  {
    fr: 'Lit King size 180*200 ou 2 lits jumeaux 90*200',
    en: 'King size bed 180*200 or 2 twin beds 90*200',
    ru: 'ru-LIT DOUBLE KING SIZE 180*200 OU 2 LITS TWINS'
  },
  {
  ...
  {
    fr: 'Soit au rez-de jardin avec un jardin privatif',
    en: 'Either on the ground floor with a private garden',
    ru: 'ru-VUE MER, DISPONIBLE AVEC TERRASSE (SUPPLÉMENT)'
  },
  {
    fr: 'Soit au 1er étage avec terrasse privée et vue sur le jardin et le port',
    en: 'Or on the 1st floor with private terrace and view on the garden and the port',
    ru: 'ru-MOBILIER DESIGN : BUREAU, DRESSING'
  },
  {
    fr: 'Soit côté parking avec terrasse privée et vue sur le Port du Croûton',
    en: 'Or on the parking side with private terrace and view on the Port du Croûton',
    ru: 'ru-COFFRE-FORT TAILLE ORDINATEUR'
  },
  {
    fr: 'Coffre-fort taille ordinateur',
  ...
  {
    fr: 'Machine Nespresso et Minibar Gourmand',
    en: 'Machine Nespresso & Minibar',
    ru: 'ru-TÉLÉPHONE'
  },
  {
    fr: 'Téléphone',
  ...
  {
    fr: 'Baignoire et Douche avec Ciel de pluie',
    en: 'Bathtub and Shower with Rain effect',
    ru: 'ru-PRODUITS D’ACCUEIL HERMÈS'
  },
  {
