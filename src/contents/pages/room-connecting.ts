...
export const contentsConnectingRoom: Record<string, IContentByLang> = {
  title: {
    fr: 'la chambre de connecting',
    en: 'en-la chambre de connecting',
    ru: 'ru-la chambre de connecting'
  },
  description: {
    fr: 'la chambre de connecting',
    en: 'en-la chambre de connecting',
...
export const contentsConnectingRoomItems: IContentByLang[] = [
  {
    fr: 'VUE MER DE 27M² À 29M² - 2 PERS',
    en: 'en-VUE MER DE 27M² À 29M² - 2 PERS',
    ru: 'ru-VUE MER DE 27M² À 29M² - 2 PERS'
