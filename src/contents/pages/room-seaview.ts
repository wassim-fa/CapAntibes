...
export const contentsSeaViewRoom: Record<string, IContentByLang> = {
  title: {
    fr: 'Chambre privilège vue mer',
    en: 'Privilege Room with sea view',
    ru: 'ru-la chambre de seaview'
  },
  description: {
    fr: 'Chambre privilège vue mer',
    en: 'Privilege Room with sea view',
...
export const contentsSeaViewRoomItems: IContentByLang[] = [
  {
    fr: 'Chambre Privilege vue mer environ 38m² pour 3 personnes maximum',
    en: 'Privilege room with sea view about 38m² for 3 persons maximum',
    ru: 'ru-VUE MER DE 27M² À 29M² - 2 PERS'
  },
  {
  ...
  {
    fr: 'Au 1er étage avec terrasse privée et vue sur la mer',
    en: 'On the 1st floor with private terrace and sea view',
    ru: 'ru-MOBILIER DESIGN : BUREAU, DRESSING'
  },
  {
    fr: 'Mobilier design : Bureau, Dressing',
    en: 'Design furniture : Desk, Dressing room',
    ru: 'ru-COFFRE-FORT TAILLE ORDINATEUR'
  },
  {
    fr: 'Coffre-fort taille ordinateur',
