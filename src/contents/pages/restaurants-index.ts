...
export const contentsRestaurantsIndex: Record<string, IContentByLang> = {
  title: {
    fr: 'restaurants • bar',
  ...
  chapter1: {
    fr: `LES PÊCHEURS RESTAURANT ÉTOILÉ`,
    en: `LES PÊCHEURS RESTAURANT ÉTOILÉ`,
    ru: `LES PÊCHEURS RESTAURANT ÉTOILÉ`
  },
  subTitle1: {
    fr: `de 7h30 à 10h30`,
    en: `de 7h30 à 10h30`,
