...
export const contentsDesignRoom: Record<string, IContentByLang> = {
  title: {
    fr: 'la chambre de design',
    en: 'en-la chambre de design',
    ru: 'ru-la chambre de design'
  },
  description: {
    fr: 'la chambre de design',
    en: 'en-la chambre de design',
...
export const contentsDesignRoomItems: IContentByLang[] = [
  {
    fr: 'VUE MER DE 27M² À 29M² - 2 PERS',
    en: 'en-VUE MER DE 27M² À 29M² - 2 PERS',
    ru: 'ru-VUE MER DE 27M² À 29M² - 2 PERS'
